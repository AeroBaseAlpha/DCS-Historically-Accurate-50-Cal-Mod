...
-- Defining guns --------------------------------------------------------------------------
    ...
    declare_weapon({category = CAT_SHELLS, name = "50Browning_Ball_M2", user_name = _("50Browning_Ball_M2"),
        ...
        round_mass      = 0.115 + 0.020, -- Assembled shell + link
        cartridge_mass  = 0.053 + 0.000, -- Empty shell (+ link if links are stored as well)
        explosive       = 0,
        v0              = 864.5,
        Dv0             = 0.0082,
        Da0             = 0.00085,
    ...
    declare_weapon({category = CAT_SHELLS, name = "50Browning_APIT_M20", user_name = _("50Browning_APIT_M20"),
        model_name      = "tracer_bullet_red",
        projectile      = "AP",
        mass            = 0.0396, -- Bullet mass
        round_mass      = 0.109 + 0.020, -- Assembled shell + link
        cartridge_mass  = 0.012 + 0.000, -- Empty shell (+ link if links are stored as well)
        --explosive       = 0.0000,
        payload         = 0.0016,
        payloadEffect   = "Thermal",
    ...
    declare_weapon({category = CAT_SHELLS, name = "50Browning_I_M1", user_name = _("50Browning_I_M1"),
        model_name      = "tracer_bullet_white",
        projectile      = "AP",
        mass            = 0.0401, -- Bullet mass
        round_mass      = 0.109 + 0.02, -- Assembled shell + link
...
-- Defining drop ordnance -----------------------------------------------------------------
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "ER_4_SC50", displayName = _("4 x SC 50 - 50kg GP Bomb LD"),
        ...
        settings = Get_Fuze_GUISettings_Preset("WWII_B_G_SCSmall")
    })
    -- end of SC 50 -----------------------------------------------------------------------
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "SC_501_SC500", displayName = _("SC 500 J - 500kg GP Bomb LD"),
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_B_G_SCMedium")
    })
    -- end of SC 500 J --------------------------------------------------------------------
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{SD_250_Stg}", displayName = _("SD 250 Stg - 250kg GP Bomb LD"),
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_B_G_SDMedium")
    })
    -- end of SD 250 Stg ------------------------------------------------------------------
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{AB_250_2_SD_2}", displayName = _("AB 250-2 - 144 x SD-2, 250kg CBU with HE submunitions"),
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_CC_G_AB250SD2")
    })
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{AB_250_2_SD_10A}", displayName = _("AB 250-2 - 17 x SD-10A, 250kg CBU with 10kg Frag/HE submunitions"),
        ...
        Elements        = {{ShapeName = "AB-250-2"}},
        settings        = Get_Fuze_GUISettings_Preset("WWII_CC_G_AB250SC10")
    })
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{AB_500_1_SD_10A}", displayName = _("AB 500-1 - 34 x SD-10A, 500kg CBU with 10kg Frag/HE submunitions"),
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_CC_G_AB500SC10")
    })
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{British_GP_250LB_Bomb_Mk1}", displayName = British_GP_250LB_Bomb_Mk1.user_name,
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkI")
    })

    declare_loadout({category = CAT_BOMBS, CLSID = "British_GP_250LBS_Bomb_MK4_on_LH_Spitfire_Wing_Carrier", displayName = British_GP_250LB_Bomb_Mk1.user_name,
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = British_GP_250LB_Bomb_Mk1.wsTypeOfWeapon,
        Cx_item = British_GP_250LB_Bomb_Mk1.Cx,
        Cx_pil = 0.00002 + British_GP_250LB_Bomb_Mk1.Cx,
        Count = 1,
        Picture = dcswwii_bomb_models["British_GP_250LB_Bomb_Mk1"].icon,
        PictureBlendColor = "0xffffffff",
        Weight_Empty = 4.0,
        Weight = 4.0 + British_GP_250LB_Bomb_Mk1.mass,
        Elements = {
            {
                ShapeName = "Spitfire_pilon2L",
                IsAdapter = true,
            },
            {
                ShapeName = dcswwii_bomb_models["British_GP_250LB_Bomb_Mk1"].file_name,
                connector_name = "Point01",
            },
        },
        settings = Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkI")
    })
    declare_loadout({category = CAT_BOMBS, CLSID = "British_GP_250LBS_Bomb_MK4_on_RH_Spitfire_Wing_Carrier", displayName = British_GP_250LB_Bomb_Mk1.user_name,
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = British_GP_250LB_Bomb_Mk1.wsTypeOfWeapon,
        Cx_item = British_GP_250LB_Bomb_Mk1.Cx,
        Cx_pil = 0.00002 + British_GP_250LB_Bomb_Mk1.Cx,
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{British_GP_250LB_Bomb_Mk4}", displayName = British_GP_250LB_Bomb_Mk4.user_name,
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV")
    })
    declare_single_bomb_on_carrier(British_GP_250LB_Bomb_Mk4, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.1}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV"))
	...
	declare_loadout({category = CAT_BOMBS, CLSID = "{British_GP_250LB_Bomb_Mk5}", displayName = British_GP_250LB_Bomb_Mk5.user_name,
		...
		settings			= Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkV")
	})
    declare_single_bomb_on_carrier(British_GP_250LB_Bomb_Mk5, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.1}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkV"))
    ...
    -- NB: The following declarations are listed as Mk. IV in their CLSIDs, however the bomb model used will be Mk. I.
    --     This came past bomb attachment redesign during the introduction of the "green range" of British ordnance.
    --     -- Made Dragon, 10/02/2021.

    declare_loadout({category = CAT_BOMBS, CLSID = "British_GP_500LBS_Bomb_MK4_on_British_UniversalBC_MK3", displayName = British_GP_500LB_Bomb_Mk1.user_name,
        attribute      = {wsType_Weapon,wsType_Bomb,wsType_Container,WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = British_GP_500LB_Bomb_Mk1.wsTypeOfWeapon,
        Cx_item = British_GP_500LB_Bomb_Mk1.Cx,
        Cx_pil = 0.00002 + British_GP_500LB_Bomb_Mk1.Cx,
        Count = 1,
        Picture = dcswwii_bomb_models["British_GP_500LB_Bomb_Mk1"].icon,
        PictureBlendColor = "0xffffffff",
        Weight_Empty = 12.0,
        Weight = 12.0 + British_GP_500LB_Bomb_Mk1.mass,
        Elements = {
            {
                ShapeName = "Spitfire_pilon1",
                IsAdapter = true,
            },
            {
                ShapeName = dcswwii_bomb_models["British_GP_500LB_Bomb_Mk1"].file_name,
                connector_name = "Point01",
            },
        },
        settings = Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkI")
    ...
    declare_single_bomb_on_carrier(British_GP_500LB_Bomb_Mk4_Short, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.45}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV"))
    ...
    declare_single_bomb_on_carrier(British_MC_250LB_Bomb_Mk1, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.25}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV"))
    ...
    declare_single_bomb_on_carrier(British_MC_250LB_Bomb_Mk2, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.25}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV"))
    ...
    declare_single_bomb_on_carrier(British_MC_500LB_Bomb_Mk1_Short, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.65}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_GPMkIV"))
	...
	declare_loadout({category = CAT_BOMBS, CLSID = "{British_SAP_250LB_Bomb_Mk5}", displayName = British_SAP_250LB_Bomb_Mk5.user_name,
		...
		settings			= Get_Fuze_GUISettings_Preset("WWII_B_B_SAP")
	})
    declare_single_bomb_on_carrier(British_SAP_250LB_Bomb_Mk5, dcswwii_carrier_models.British_Handley_Page_Type_B_Cut_Bar, {{3, 0.0}}, "", Get_Fuze_GUISettings_Preset("WWII_B_B_SAP"))
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{AN_M30A1}", displayName = _("AN-M30A1 - 100lb GP Bomb LD"),
		...
		settings		= Get_Fuze_GUISettings_Preset("WWII_B_A_GPSmall")
	})
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "{AN_M65}", displayName = _("AN-M65 - 1000lb GP Bomb LD"),
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_B_A_GPLarge")
	})
...
-- Defining unguided rocket shells --------------------------------------------------------
    ...
    declare_loadout({category = CAT_ROCKETS, 
		CLSID = "{WGr21}", 
		displayName = _("Werfer-Granate 21 - 21 cm UnGd air-to-air rocket"),
        ...
        settings = Get_Fuze_GUISettings_Preset("WWII_R_G_WGr21")
    })
    -- end of Wfr. Gr. 21 -----------------------------------------------------------------
    ...
    declare_loadout({category = CAT_ROCKETS, CLSID = "{British_HE_60LBFNo1_3INCHNo1}", displayName = British_HE_60LBFNo1_3INCHNo1.displayName,
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_R_B_RP3F")
    })
    ...
    declare_loadout({category = CAT_ROCKETS, CLSID = "{British_HE_60LBSAPNo2_3INCHNo1}", displayName = British_HE_60LBSAPNo2_3INCHNo1.displayName,
        ...
        settings        = Get_Fuze_GUISettings_Preset("WWII_R_B_RP3SAP")
    })
    ...
    mossie_hvars("{MOSSIE_4_British_HE_60LBFNo1_3INCHNo1_ON_LEFT_WING_RAILS}",    British_HE_60LBFNo1_3INCHNo1,   {"PYLON_1", "PYLON_2", "PYLON_3", "PYLON_5"},   "british_RS_60lb_F_No1.png",      Get_Fuze_GUISettings_Preset("WWII_R_B_RP3F"))
    mossie_hvars("{MOSSIE_4_British_HE_60LBFNo1_3INCHNo1_ON_RIGHT_WING_RAILS}",   British_HE_60LBFNo1_3INCHNo1,   {"PYLON_12", "PYLON_11", "PYLON_9", "PYLON_8"}, "british_RS_60lb_F_No1.png",      Get_Fuze_GUISettings_Preset("WWII_R_B_RP3F"))
    mossie_hvars("{MOSSIE_2_British_HE_60LBFNo1_3INCHNo1_ON_LEFT_WING_RAILS}",    British_HE_60LBFNo1_3INCHNo1,   {"PYLON_1", "PYLON_2"},                         "british_RS_60lb_F_No1.png",      Get_Fuze_GUISettings_Preset("WWII_R_B_RP3F"))
    mossie_hvars("{MOSSIE_2_British_HE_60LBFNo1_3INCHNo1_ON_RIGHT_WING_RAILS}",   British_HE_60LBFNo1_3INCHNo1,   {"PYLON_12", "PYLON_11"},                       "british_RS_60lb_F_No1.png",      Get_Fuze_GUISettings_Preset("WWII_R_B_RP3F"))
    mossie_hvars("{MOSSIE_4_British_HE_60LBSAPNo2_3INCHNo1_ON_LEFT_WING_RAILS}",  British_HE_60LBSAPNo2_3INCHNo1, {"PYLON_1", "PYLON_2", "PYLON_3", "PYLON_5"},   "british_RS_60lb_SAP_No2.png",    Get_Fuze_GUISettings_Preset("WWII_R_B_RP3SAP"))
    mossie_hvars("{MOSSIE_4_British_HE_60LBSAPNo2_3INCHNo1_ON_RIGHT_WING_RAILS}", British_HE_60LBSAPNo2_3INCHNo1, {"PYLON_12", "PYLON_11", "PYLON_9", "PYLON_8"}, "british_RS_60lb_SAP_No2.png",    Get_Fuze_GUISettings_Preset("WWII_R_B_RP3SAP"))
    mossie_hvars("{MOSSIE_2_British_HE_60LBSAPNo2_3INCHNo1_ON_LEFT_WING_RAILS}",  British_HE_60LBSAPNo2_3INCHNo1, {"PYLON_1", "PYLON_2"},                         "british_RS_60lb_SAP_No2.png",    Get_Fuze_GUISettings_Preset("WWII_R_B_RP3SAP"))
    mossie_hvars("{MOSSIE_2_British_HE_60LBSAPNo2_3INCHNo1_ON_RIGHT_WING_RAILS}", British_HE_60LBSAPNo2_3INCHNo1, {"PYLON_12", "PYLON_11"},                       "british_RS_60lb_SAP_No2.png",    Get_Fuze_GUISettings_Preset("WWII_R_B_RP3SAP"))
...
-- Defining fuel tanks --------------------------------------------------------------------
    ...
    -- UK 45 gal. slipper tank ------------------------------------------------------------
    declare_loadout({category = CAT_FUEL_TANKS, CLSID = "SPITFIRE_45GAL_SLIPPER_TANK", displayName = _("45 gal. Slipper Tank"),
        attribute = {wsType_Air, wsType_Free_Fall, wsType_FuelTank, WSTYPE_PLACEHOLDER},
        Picture = "british_Spitfire_Slipper.png",
        PictureBlendColor = "0xffffffff",
        Weight_Empty = 16.0,
        Weight = 16.0 + 122.647,
        ...
        shape_table_data = {
            {
                file = "Spitfire_slipper_tank";
                life = 1;
                fire = {0, 1};
                username = "SPITFIRE_45GAL_SLIPPER_TANK";
                index = WSTYPE_PLACEHOLDER;
            },
        },
        Elements = {
            {
                ShapeName = "Spitfire_slipper_tank",
            },
        },
    })
    -- End of UK 45 gal. slipper tank -----------------------------------------------------

    -- UK 45 gal. torpedo tank ------------------------------------------------------------
    declare_loadout({category = CAT_FUEL_TANKS, CLSID = "SPITFIRE_45GAL_TORPEDO_TANK", displayName = _("45 gal. Torpedo Tank"),
        attribute = {wsType_Air, wsType_Free_Fall, wsType_FuelTank, WSTYPE_PLACEHOLDER},
        Picture = "british_Spitfire_TTank.png",
        PictureBlendColor = "0xffffffff",
        Weight_Empty = 22.0,
        Weight = 22.0 + 122.647,
        Cx_pil = 0.00008708,
        shape_table_data = {
            {
                file = "Spitfire_tank_1";
                life = 1;
                fire = {0, 1};
                username = "SPITFIRE_45GAL_TORPEDO_TANK";
                index = WSTYPE_PLACEHOLDER;
            },
        },
        Elements = {
            {
                ShapeName = "Spitfire_tank_1",
            },
        },
    })
    -- End of UK 45 gal. torpedo tank -----------------------------------------------------

    -- UK 50 gal. slipper tank ------------------------------------------------------------
    ...
    -- End of UK 50 gal. slipper tank -----------------------------------------------------

    -- UK 100 gal. slipper tank -----------------------------------------------------------
    ...
    -- End of UK 100 gal. slipper tank ----------------------------------------------------
...
-- Defining specialized armament ----------------------------------------------------------
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "Beer_Bomb_(L)_on_LH_Spitfire_Wing_Carrier", displayName = BEER_BOMB.user_name .. " " .. _("(Pale Ale)"),
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = BEER_BOMB.wsTypeOfWeapon,
        Cx_item = BEER_BOMB.Cx,
        Cx_pil = 0.00002 + BEER_BOMB.Cx,
        Count = 1,
        Picture = dcswwii_bomb_models["BEER_BOMB"].icon,
        PictureBlendColor = "0xffffffff",
        Weight_Empty = 4.0,
        Weight = 4.0 + BEER_BOMB.mass,
        Elements = {
            {
                ShapeName = "Spitfire_pilon2L",
                IsAdapter = true,
            ...
            {
                ShapeName = dcswwii_bomb_models["BEER_BOMB"].file_name,
                connector_name = "Point01", -- to
                attach_point_connector = "AttahPoint",  -- with
            },
        },
    })
    declare_loadout({category = CAT_BOMBS, CLSID = "Beer_Bomb_(L)_on_RH_Spitfire_Wing_Carrier", displayName = BEER_BOMB.user_name .. " " .. _("(Pale Ale)"),
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = BEER_BOMB.wsTypeOfWeapon,
        Cx_item = BEER_BOMB.Cx,
        Cx_pil = 0.00002 + BEER_BOMB.Cx,
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "Beer_Bomb_(D)_on_LH_Spitfire_Wing_Carrier", displayName = BEER_BOMB.user_name .. " " .. _("(Bitter Ale)"),
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = BEER_BOMB.wsTypeOfWeapon,
        Cx_item = BEER_BOMB.Cx,
        Cx_pil = 0.00002 + BEER_BOMB.Cx,
    ...
    declare_loadout({category = CAT_BOMBS, CLSID = "Beer_Bomb_(D)_on_RH_Spitfire_Wing_Carrier", displayName = BEER_BOMB.user_name .. " " .. _("(Bitter Ale)"),
        attribute      = {wsType_Weapon, wsType_Bomb, wsType_Container, WSTYPE_PLACEHOLDER},
        wsTypeOfWeapon = BEER_BOMB.wsTypeOfWeapon,
        Cx_item = BEER_BOMB.Cx,
        Cx_pil = 0.00002 + BEER_BOMB.Cx,
